...
const questionHeading = document.querySelector('#question-box h3')
...
const getTriviaButton = document.querySelector('#get-trivia-btn')
getTriviaButton.addEventListener('click', () => {

    fetch(`https://opentdb.com/api.php?amount=1&category=${categoryMenu.value}&difficulty=${currentDifficulty}`)
        ...
        .then((data) => {
            ...
            answerButtons.forEach((button, i) => {
                // put as textContent the button's ID + an answer
...
function evaluateChoice (event) {
    ...
    scoreBox.innerHTML = `Tries: ${tries} &nbsp; &nbsp; &nbsp; Score: ${score} &nbsp; &nbsp; &nbsp; Avg: ${average}%`


}

// const correctAnswer = correctAnswer.isCorrect;
// correctAnswer.addEventListener('click', () => {
//     if (correctAnswer){
//         getTriviaButton.style.display = 'none'
//     } 
// })
...
// const selectedRadioBtn = radioDiv.filter(radBtn => radBtn.checked);
